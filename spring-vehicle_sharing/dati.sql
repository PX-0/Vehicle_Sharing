...
values("Benzina", "Fiat 600, colore blue cobalto", "false", "Fiato600.jpg", "Via dei colli della serpentara 00139", "Auto", "Utente 3", "Veicolo 3");
...
INSERT INTO veicoli (veicolo_id, tipologia, alimentazione, descrizione, posizione_attuale, disponibilita_noleggio, immagine_veicolo, utente_ins) VALUES ('Tesla', 'Auto', 'Elettricità', 'Model Y, colore rosso', 'Italia, Roma, Via Genzano 80', 'true', 'https://www.example.org', 'Paolo');
...
INSERT INTO prenotazioni (utente_id, veicolo_id, data_prenotazione, pagamento_id) values ('Paolo', 'Tesla', 20221010101022, 3);